...
describe("App component", () => {
  ...
  it("contains the text Value: 1 (smoke test) (Enzyme shallow)", () => {
    const wrapper = shallow(<Counter />);
    expect(wrapper.containsMatchingElement(<button>Value: 1</button>)).toBe(
      true
    );
  });

  it("tests click event counter (smoke test) (Enzyme shallow)", () => {
    const wrapper = shallow(<Counter />);
